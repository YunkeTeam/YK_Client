                  ...
                  <div class="vx-row">
                      <div class="vx-col w-full">
                          <vx-card class="px-4">
                              ...
                              <div class="vx-row w-full border-b border-l-0 border-r-0 border-t-0 d-theme-border-grey-light border-solid flex justify-between flex items-center">
                                  <div class="vx-col sm:w-4/5 w-full flex flex-wrap items-center mb-2">
                                      <div class="flex flex-col my-2">
                                          <h4 class="mb-1" style="color: rebeccapurple">{{currentNews.title}}</h4>
                                          <div class="flex items-center">
                                              <span style="font-size: 1rem;font-weight: bold">{{currentNews.author}}</span>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="vx-col sm:w-1/5 w-full flex sm:flex-col items-center sm:justify-end mb-2">
                                      时间:<span class="flex self-end sm:mt-2 mt-0 whitespace-no-wrap">{{currentNews.time}}</span>
                                  </div>
                              </div>
                              ...
                              <div class="vx-row">
                                  <div class="vx-col w-full">
                                      <div class="mail__content break-words mt-8 mb-4" v-html="currentNews.description"></div>
                                  </div>
                              </div>
                          </vx-card>
                      </div>
...
export default{
    mounted() {
      this.currentNews = this.$store.state.newsDetail;
    },
    data() {
        return {
            showThread: false,
